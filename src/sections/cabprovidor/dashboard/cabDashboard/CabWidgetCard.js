...
function TableWidgetCard({ color, title, count, percentage, isLoss, cab, isActive }) {
  return (
        ...
        <Grid item xs={12}>
          <Stack spacing={0.25}>
            ...
            <Stack direction="row" spacing={1} alignItems="center">
              <Typography variant="h5">{cab}</Typography>
              <Typography color="secondary">cabs</Typography>
            </Stack>
          </Stack>
        </Grid>
      </Grid>
