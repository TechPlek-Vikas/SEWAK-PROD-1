...
const Create = () => {
  ...
  const { isCustomerOpen, countries, country, lists, isOpen } =
        ...
        <MainCard>
          ...
          >
            {({
              ...
              let taxRate = values.invoice_detail.reduce(
                (accumulator, item) => {
                            ...
                            >
                              {editMode ? (
                                <Button
                                  variant="outlined"
                                  color="secondary"
                                  onClick={handleSaveCashierDetails}
                                  size="small"
                                >
                                  Save
                                </Button>
                        ...
                        <Grid container spacing={2}>
                          <Grid item xs={12} sm={8}>
                            <Stack spacing={2}>
                              ...
                              <Stack sx={{ width: "100%" }}>
                                <Typography variant="subtitle1">
                                  {values?.customerInfo?.company_name || ""}
                                </Typography>
                                {values?.customerInfo?.address && (
                                  <Typography color="secondary">
                                    {values?.customerInfo?.address}
                                    {values?.customerInfo?.city &&
                                      `, ${values?.customerInfo?.city}`}
                            ...
                            <>
                              <TableContainer>
                                <Table sx={{ minWidth: 650 }}>
                                  ...
                                  <TableBody>
                                    {values.invoice_detail?.map(
                                      (item, index) => (
                                        <TableRow key={item.id}>
                                          <TableCell>
                                            {values.invoice_detail.indexOf(
                                              item
                                            ) + 1}
                                          </TableCell>
                                          <InvoiceItem
                              ...
                              <Divider />
                              {touched.invoice_detail &&
                                errors.invoice_detail &&
                                !Array.isArray(errors?.invoice_detail) && (
                                  <Stack
                                    direction="row"
                              ...
                              <Stack spacing={2}>
                                ...
                                >
                                  ...
                                  <Button
                                    ...
                                    startIcon={<Edit />}
                                    color="secondary"
                                    onClick={handleBankDetailsEditToggle}
                                  >
                                ...
                                {isBankDetailsEditing ? (
                                  <Grid container spacing={2}>
                                    ...
                                    <Grid item xs={12} sm={6}>
                                      <TextField
                                        ...
                                        fullWidth
                                        value={
                                          values.bank_details?.accountNumber ||
                                          ""
                                        }
                                        onChange={(e) =>
                                          setFieldValue(
                                  ...
                                  <Stack spacing={2}>
                                    ...
                                    <Typography variant="body1">
                                      ...
                                      {values.bank_details?.accountHolderName ||
                                        "N/A"}
                                    </Typography>
                                    ...
                                    <Typography variant="body1">
                                      ...
                                      {values.bank_details?.IFSCCode || "N/A"}
                                    </Typography>

                                    {/* Display Bank Name */}
                                    <Typography variant="body1">
                                      <strong>Bank Name:</strong>{" "}
                                      {values.bank_details?.bankName || "N/A"}
                                    </Typography>
                                  </Stack>
                                )}
                              </Stack>
                        ...
                        <FormControl sx={{ width: { xs: "100%", sm: 250 } }}>
                          <Autocomplete
                            ...
                            value={countries.find(
                              (option) => option.code === country?.code
                            )}
                            sx={{
                              "& .MuiInputBase-input": {
                                padding: "8px",
