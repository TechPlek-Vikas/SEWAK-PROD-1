...
import CompanyWidgetCard from '../../../sections/cabprovidor/dashboard/companyDashboard/CompanyWidgetCard';
import { Dialog } from '@mui/material';
import { PopupTransition } from 'components/@extended/Transitions';
import AddCompanyFileForm from 'sections/cabprovidor/dashboard/companyDashboard/AddCompanyFileForm';
...
export default function CompanyDashboard() {
  ...
  let breadcrumbLinks = [{ title: 'Home', to: APP_DEFAULT_PATH }, { title: 'Company Summary' }];

  return (
    <>
      <Breadcrumbs custom heading="Company Dashboard" links={breadcrumbLinks} />
      <Grid container spacing={2.5}>
        <Grid item xs={12} lg={9}>
          <MainCard>
            <Grid container spacing={2}>
              ...
              <Grid item xs={12}>
                <CompanyIncomeAreaChart series={series} />
              </Grid>
            </Grid>
          </MainCard>
        </Grid>
        <Grid item xs={12} lg={3}>
          <CompanyCard handleFileUploadDialogue={handleFileUploadDialogue} />
        </Grid>
      </Grid>
        ...
        >
          <AddCompanyFileForm handleClose={handleFileUploadDialogue}  />
        </Dialog>
